...
<%--        <label class="layui-form-label">角色编码</label>--%>
        <div class="layui-input-block">
            <input type="hidden" name="code" lay-verify="required" lay-reqtext="角色编码是必填项，不能为空鸭" autocomplete="off" placeholder="请输入角色编码" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
